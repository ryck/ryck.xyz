...
**Computername\_MACaddress** El nombre del sparsebundle tiene que seguir esta estructura, es decir, el nombre del equipo, guión bajo, numero MAC (todo seguido, solo los números y las letras). Algo así: RickBook\_001ec4b8f9b3 El nombre del equipo supongo que lo sabréis, y la MAC se puede obtener con este comando:
