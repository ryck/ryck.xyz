...
image: '/static/images/unifi-usg-sky/modem.jpg'
---

<Image
  alt={`Hello`}
  src={`/static/images/unifi-usg-sky/modem.jpg`}
  width={6016}
  height={4000}
  priority
/>
...
Sky uses a weird protocol to provide you username and password. Previously, you would need to sniff your network traffic to find those out, but, thankfully, not anymore, and you can use anything.
...
Depending on what are you using to host the controller (CloudKey, Docker, etc) yout `config.gateway.json` location can change, but Ubiquiti has a very nice documentation: [UniFi - USG Advanced Configuration Using config.gateway.json](https://help.ui.com/hc/en-us/articles/215458888-UniFi-USG-Advanced-Configuration-Using-config-gateway-json)

Once you have the right configuration in your `config.gateway.json`, force a reprovision and wait. Sometimes Sky takes a long time to lease you a new IP, so don't dispair and give it some time (I am talking about up tp a couple of hours)
