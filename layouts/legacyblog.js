...
const editUrl = (slug) =>
  `https://github.com/ryck/ryck.xyz/edit/main/data/legacy/${slug}.mdx`;
const discussUrl = (slug) =>
  `https://mobile.twitter.com/search?q=${encodeURIComponent(
    `https://ryck.xyz/blog/legacy/${slug}`
  )}`;

export default function LegacyBlogLayout({ children, frontMatter }) {
  return (
    <Container
